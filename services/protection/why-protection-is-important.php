...
<body>
    ...
    <section>
        <div class="container">
            <div class="Hdnew">
                ...
                <h1 data-aos="fade-up">Why Protection is Important</h1>
            </div>
            <div class="banner-bg">
    ...
    <section class="greenbg">
        <div class="container-sm">
            <div class="subHd">
                <h3 data-aos="fade-up" data-aos-delay="100">Why Protection is Important</h3>
                <p data-aos="fade-up" data-aos-delay="200">There are events we can all face that have the potential to disrupt lives, standards of living and families. It’s a difficult issue to think about but imagine the impact on you and your family should the main earner in your household die or become seriously ill. It may not happen to you – we hope it doesn’t – but it might.</p>
                <p data-aos="fade-up" data-aos-delay="300">While there is no insurance that can prevent these things from happening, you can protect yourself and your family financially by making money available, should something unexpected happen.</p>
                <p data-aos="fade-up" data-aos-delay="400">This money can be the difference between keeping and losing your home and maintaining your family’s lifestyle.</p>
   ...
   <section class="whyNeed">
    ...
    <section class="ourService">
        <div class="container-sm">
            <div class="Hd">
                <h3 data-aos="fade-up" data-aos-delay="100">Other Areas of Expertise</h3>
            </div>
            <div class="service_grid_main">
                ...
                <div class="service_grid">
                    <a href="<?= $base_url ?>services/retirement-planning.php" data-aos="fade-up" data-aos-delay="200">
