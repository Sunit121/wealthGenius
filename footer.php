...
<footer class="hide-trigger">
    <div class="container">
        <div class="footer-main">
            <div class="footer-info">
                ...
                <div class="footer-about">
                    ...
                    <p data-aos="fade-up" data-aos-delay="500">Approver Quilter Financial Services Limited 06/05/2025</p>
                </div>
            </div>
            ...
            <ul>
                <li data-aos="fade-up" data-aos-delay="100"><a href="<?= $base_url ?>services/investment.php">Investments</a></li>
                <li data-aos="fade-up" data-aos-delay="200"><a href="<?= $base_url ?>services/retirement-planning.php">Retirement Planning</a></li>
                <li data-aos="fade-up" data-aos-delay="300"><a href="<?= $base_url ?>nhs-pension-guidance.php">NHS Pension Planning</a></li>
                <li data-aos="fade-up" data-aos-delay="400"><a href="<?= $base_url ?>services/protection.php">Protection</a></li>
                <li data-aos="fade-up" data-aos-delay="500"><a href="<?= $base_url ?>mortgages.php">Mortgages</a></li>
                <li data-aos="fade-up" data-aos-delay="600"><a href="<?= $base_url ?>services/taxation.php">Tax Planning</a></li>
            </ul>
            </div>
            <div class="footer-links">
        ...
        <p>© 2026 Wealth Genius. All Rights Reserved.</p>
        </div>
    </div>
</footer>