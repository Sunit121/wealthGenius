    ...
    <div class="ContactForm serviceForm">
        ...
        <div class="submit-query">
            <div class="checked-query">
                ...
                <label for="agree">
                    Please tick this box to confirm you have read and understood our <a href="https://www.quilter.com/important-information/privacy-notices/appointed-representative-privacy-notice/" target="_blank"> Privacy Notice.</a>
                </label>
            </div>
