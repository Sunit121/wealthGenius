...
<head>
    ...
    <title>NHS Professionals | Wealth Genius</title>
        ...
        <div class="container-sm">
            ...
            <div class="hero-content text-center">
                ...
                <div class="hero-btns" data-aos="fade-up" data-aos-delay="300">
                    <a href="<?= $base_url ?>contact.php" class="btn btn-green">Book Free initial consultation &rarr;</a>
                    <a href="<?= $base_url ?>assets/images/WG-McCloud-Factsheet.pdf" class="btn btn-outline">Download McCloud Guide</a>
                </div>
            </div>
        </div>
    </div>
       ...
       <section class="network panel">
        <div class="container-sm">
            ...
            <div class="MacCloudResourceHd">
                <h3>McCloud Remedy Guide</h3>
                 <div class="resourcesBtn"  data-aos="fade-up">
            <a href="<?= $base_url ?>assets/images/WG-McCloud-Factsheet.pdf">Download</a>
            </div>
            </div>
           </div>
